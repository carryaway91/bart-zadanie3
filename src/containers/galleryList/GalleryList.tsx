...
import { getImagesForGalleryList, pushToGallery, sortByImgAndModifiedProp } from '../../util/galleryList/GalleryListUtils'
...
const GalleryList: React.FC<IProps> = ({ setLoaded, loaded, reload, cancelReload }) => {
